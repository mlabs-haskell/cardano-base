...
tests =
  ...
  , testKESAlgorithm (Proxy :: Proxy IO) (Proxy :: Proxy (CompactSum1KES Ed25519DSIGNM Blake2b_256)) "CompactSum1KES"
  , testKESAlgorithm (Proxy :: Proxy IO) (Proxy :: Proxy (CompactSum2KES Ed25519DSIGNM Blake2b_256)) "CompactSum2KES"
  , testKESAlgorithm (Proxy :: Proxy IO) (Proxy :: Proxy (CompactSum5KES Ed25519DSIGNM Blake2b_256)) "CompactSum5KES"
  ]
...
prop_allUpdatesSignKeyKES _ sk_0 = ioProperty . io $ do
  void $ withAllUpdatesKES_ @m sk_0 $ const (return ())
